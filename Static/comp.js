...
var _lynn$elm_ordinal$Ordinal$ordinalSuffix = function (n) {
	var n_ = _elm_lang$core$Basics$abs(n);
	if (_elm_lang$core$Native_Utils.eq(
		(A2(_elm_lang$core$Basics_ops['%'], n_, 100) / 10) | 0,
		1)) {
		return 'th';
	} else {
		var _p0 = A2(_elm_lang$core$Basics_ops['%'], n_, 10);
		switch (_p0) {
			case 1:
				return 'st';
			case 2:
...
var _lynn$elm_ordinal$Ordinal$ordinal = function (n) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(n),
		_lynn$elm_ordinal$Ordinal$ordinalSuffix(n));
};
...
var _user$project$Main$isNothing = function (x) {
	var _p0 = x;
	if (_p0.ctor === 'Nothing') {
		return true;
	} else {
...
var _user$project$Main$compareP = F4(
	function (people, method, c1, c2) {
		var _p2 = {
			ctor: '_Tuple2',
			_0: A2(_user$project$Main$findPerson, c1.id, people),
			_1: A2(_user$project$Main$findPerson, c2.id, people)
		};
			...
			if (_p3.ctor === 'Just') {
				...
				var _p4 = {
					...
					_0: A2(
						_elm_lang$core$List$any,
						function (a) {
							return _elm_lang$core$Native_Utils.eq(a, _p6);
						},
						c1.events),
					_1: A2(
						_elm_lang$core$List$any,
				...
				var _p5 = {
					ctor: '_Tuple2',
					_0: A2(_elm_lang$core$Dict$get, _p6, _p7.avgs),
					_1: A2(_elm_lang$core$Dict$get, _p6, _p8.avgs)
				};
				_v5_5:
				do {
					if (_p5.ctor === '_Tuple2') {
						if (_p5._0.ctor === 'Nothing') {
							...
							if (_p5._1.ctor === 'Just') {
								if (_p5._0._0.ctor === 'Time') {
									if (_p5._1._0.ctor === 'Time') {
										return A2(_elm_lang$core$Basics$compare, _p5._0._0._0, _p5._1._0._0);
									} else {
										return _elm_lang$core$Basics$LT;
									}
								} else {
				...
				return A2(_elm_lang$core$Basics$compare, _p7.name, _p8.name);
			}
		} else {
			return _elm_lang$core$Basics$EQ;
		}
	});
var _user$project$Main$decodePlaces = _elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$float);
...
var _user$project$Main$Loaded = F3(
	function (a, b, c) {
		return {ctor: 'Loaded', _0: a, _1: b, _2: c};
	});
var _user$project$Main$Waiting = F2(
	function (a, b) {
		return {ctor: 'Waiting', _0: a, _1: b};
	});
...
var _user$project$Main$SelectedEvent = function (a) {
	return {ctor: 'SelectedEvent', _0: a};
};
var _user$project$Main$displayEvent = F4(
	function (select, event, competitor, person) {
		var isSelected = function () {
			var _p9 = select;
			if (_p9.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p9._0.id, person.id);
			} else {
				return false;
			}
		}();
		var _p10 = A2(_elm_lang$core$Dict$get, event, person.avgs);
		if (_p10.ctor === 'Nothing') {
			...
			return A2(
				_elm_lang$core$List$any,
				function (a) {
					return _elm_lang$core$Native_Utils.eq(a, event);
				},
				competitor.events) ? ((_user$project$Main$isJust(select) && isSelected) ? A2(
				_elm_lang$html$Html$td,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('event'),
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Main$SelectedEvent(event)),
							_1: {ctor: '[]'}
						}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_user$project$Base$viewTime(_p11)),
					_1: {ctor: '[]'}
				}) : A2(
				_elm_lang$html$Html$td,
				{
...
var _user$project$Main$ParseOther = function (a) {
	return {ctor: 'ParseOther', _0: a};
};
var _user$project$Main$SelectedOther = {ctor: 'SelectedOther'};
var _user$project$Main$SetOther = function (a) {
	return {ctor: 'SetOther', _0: a};
};
var _user$project$Main$SelectedPerson = function (a) {
	return {ctor: 'SelectedPerson', _0: a};
};
var _user$project$Main$viewCompetitor = F4(
	function (select, competition, competitor, person) {
		var tClass = function () {
			var _p12 = select;
			if (_p12.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p12._0.id, person.id) ? 'competitor selected' : 'competitor deselected';
			} else {
				return 'competitor';
			}
		}();
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(tClass),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$Basics_ops['++'],
						...
						},
						{
							...
							_0: A2(
								_elm_lang$html$Html$a,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Main$SelectedPerson(person)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
				...
				A2(
					_elm_lang$core$List$map,
					function (event) {
						return A4(_user$project$Main$displayEvent, select, event, competitor, person);
					},
					competition.events)));
	});
var _user$project$Main$viewCompetitors = F4(
	function (sort, competition, people, selected) {
		var person = function () {
			var _p13 = selected;
			if (_p13.ctor === 'Just') {
				var _p14 = _p13._0;
				return (!A2(
					_elm_lang$core$List$any,
					function (p) {
						return _elm_lang$core$Native_Utils.eq(_p14.id, p.id);
					},
					competition.competitors)) ? {
					ctor: '::',
					_0: A4(
						_user$project$Main$viewCompetitor,
						selected,
						competition,
						A3(
							_user$project$Base$Competitor,
							_p14.id,
							_p14.name,
							_elm_lang$core$Dict$keys(_p14.times)),
						_p14),
					_1: {ctor: '[]'}
				} : {ctor: '[]'};
			} else {
		...
		var competitors = A2(
			...
			function (competitor) {
				var _p15 = A2(_user$project$Main$findPerson, competitor.id, people);
				if (_p15.ctor === 'Nothing') {
					return _elm_lang$core$Maybe$Nothing;
				} else {
					return _elm_lang$core$Maybe$Just(
						A4(_user$project$Main$viewCompetitor, selected, competition, competitor, _p15._0));
				}
			},
			A2(
				_elm_lang$core$List$sortWith,
				A2(_user$project$Main$compareP, people, sort),
				competition.competitors));
		return A2(
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('back'),
					_1: {
						ctor: '::',
														...
														_elm_lang$html$Html$span,
														{
															...
															_0: _elm_lang$html$Html_Attributes$class(
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	'flag-icon flag-icon-',
																	_elm_lang$core$String$toLower(_p17.country_iso))),
															_1: {ctor: '[]'}
														},
														{ctor: '[]'}),
													_1: {
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(_p17.country_name),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html$text(
																	A2(_elm_lang$core$Basics_ops['++'], ', ', _p17.city)),
																_1: {ctor: '[]'}
															}
														}
													}
					...
					_1: {
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetOther),
													_1: {ctor: '[]'}
												}
											}
										},
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p19 = model.selected;
									if ((_p19.ctor === 'Just') && (_p19._0.ctor === 'Loaded')) {
										var placesWithIndexed = A2(
											...
											A2(
												...
												function (_p20) {
													var _p21 = _p20;
													return _elm_lang$core$Native_Utils.cmp(_p21._1, 1.0e-2) > 0;
												},
												A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{ctor: '[]'},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_elm_lang$core$Basics_ops['++'], _p19._0._0.name, ' has the following chances in ')),
														_1: {
															ctor: '::',
															_0: _user$project$Main$genIcon(_p19._0._1),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html$text(':'),
																_1: {ctor: '[]'}
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$id('chances'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
																	...
																	function (_p23) {
																		...
																		return A2(
																			...
																			{ctor: '[]'},
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text(
																					_lynn$elm_ordinal$Ordinal$ordinal(_p24._0 + 1)),
																				_1: {ctor: '[]'}
																			});
																	},
																	placesWithIndexed)),
																			...
																			return A2(
																				...
																				{ctor: '[]'},
																				{
																					...
																					_0: _elm_lang$html$Html$text(
																						A2(
																							_elm_lang$core$Basics_ops['++'],
																							_user$project$Base$stf2(_p26._1 * 100),
																							'%')),
																					_1: {ctor: '[]'}
																				});
																		},
													...
													_0: function () {
														...
														if ((_p28.ctor === 'Just') && (_p28._0.ctor === 'SelectEvent')) {
															return A4(
																...
																_p29,
																model.people,
																_elm_lang$core$Maybe$Just(_p28._0._0));
														} else {
															return A4(_user$project$Main$viewCompetitors, model.sortBy, _p29, model.people, _elm_lang$core$Maybe$Nothing);
														}
													}(),
													_1: {
														ctor: '::',
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p30.ctor) {
			...
			case 'SelectedPerson':
				var _p33 = model.selected;
				if ((_p33.ctor === 'Just') && (_p33._0.ctor === 'SelectEvent')) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								selected: _elm_lang$core$Maybe$Just(
									_user$project$Main$SelectEvent(_p30._0)),
								matching: {ctor: '[]'}
							}),
						{ctor: '[]'});
				}
			...
			case 'SelectedOther':
				return A2(
					...
					model,
					{
						...
						_0: A2(
							_elm_lang$http$Http$send,
							_user$project$Main$ParseOther,
							_elm_lang$http$Http$getString(
								A2(_elm_lang$core$Basics_ops['++'], 'api/people/', model.search))),
						_1: {ctor: '[]'}
					});
			case 'ParseOther':
				var _p34 = _p30._0;
						...
						if ((_p36.ctor === '::') && (_p36._1.ctor === '[]')) {
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									...
									{
										selected: _elm_lang$core$Maybe$Just(
											_user$project$Main$SelectEvent(_p36._0)),
										matching: {ctor: '[]'}
									}),
								{ctor: '[]'});
						} else {
			...
			case 'SelectedEvent':
				var _p40 = _p30._0;
				var _p38 = model.selected;
				if ((_p38.ctor === 'Just') && (_p38._0.ctor === 'SelectEvent')) {
					var _p39 = _p38._0._0;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							...
							{
								selected: _elm_lang$core$Maybe$Just(
									A2(_user$project$Main$Waiting, _p39, _p40)),
								matching: {ctor: '[]'}
							}),
						{
							ctor: '::',
							_0: A2(
								_elm_lang$http$Http$send,
								_user$project$Main$ParseChances,
								_elm_lang$http$Http$getString(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'api/place/',
			...
			case 'ParseChances':
				var _p41 = {ctor: '_Tuple2', _0: _p30._0, _1: model.selected};
				_v25_2:
				do {
					if (_p41.ctor === '_Tuple2') {
						if (_p41._0.ctor === 'Ok') {
							if ((_p41._1.ctor === 'Just') && (_p41._1._0.ctor === 'Waiting')) {
								var _p42 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$decodePlaces, _p41._0._0);
								if (_p42.ctor === 'Ok') {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											...
											{
												selected: _elm_lang$core$Maybe$Just(
													A3(_user$project$Main$Loaded, _p41._1._0._0, _p41._1._0._1, _p42._0))
											}),
										{ctor: '[]'});
								} else {
									return A2(
			...
			case 'ParseComp':
				if (_p30._0.ctor === 'Ok') {
					var _p31 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$decodeCompAndPeople, _p30._0._0);
					if (_p31.ctor === 'Ok') {
						var _p32 = _p31._0._0;
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									comp: _elm_lang$core$Maybe$Just(_p32),
									people: _p31._0._1
								}),
							{
								ctor: '::',
								_0: _user$project$Main$title(_p32.name),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				...
				_0: A2(
					_elm_lang$core$Task$perform,
					_user$project$Main$SelectedEvent,
					_elm_lang$core$Task$succeed('333')),
				_1: {
					ctor: '::',
					_0: cmd,
					_1: {ctor: '[]'}
