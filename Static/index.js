			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Competition'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												_user$project$Base$viewDate(comp.date)),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Main$sortings = {
	...
	_1: {
		...
		_0: {
			...
			_1: F2(
				function (c1, c2) {
					return A2(_elm_lang$core$Basics$compare, c1.name, c2.name);
				})
		},
		_1: {
			ctor: '::',
			_0: {
				...
				_1: F2(
					function (c1, c2) {
						return A2(
							_elm_lang$core$Basics$compare,
							_elm_lang$core$List$length(c2.competitors),
							_elm_lang$core$List$length(c1.competitors));
					})
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: F2(
						function (c1, c2) {
							return A2(
								_elm_lang$core$Basics$compare,
								_elm_lang$core$List$length(c2.events),
								_elm_lang$core$List$length(c1.events));
						})
				},
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$viewDropdown = function (model) {
	return A2(
		_elm_lang$html$Html$select,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetSorting),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$map,
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Other links: '),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$href('gh/soviet-sim/index.html'),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('☭☭☭ Soviet Simulator ☭☭☭'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}),
														...
														_0: A2(
															...
															{ctor: '[]'},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$href('gh/tri-2048/index.html'),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Tri-2048'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}),
